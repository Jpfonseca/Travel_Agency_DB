...
INSERT INTO Recibo VALUES(222154988,5151,'2009-02-09',(SELECT N_Reserva FROM Reserva WHERE N_Reserva=1));
INSERT INTO Recibo VALUES(555849985,51531,'2009-02-09',(SELECT N_Reserva FROM Reserva WHERE N_Reserva=2));
INSERT INTO Recibo VALUES(848961861,51251,'2009-02-09',(SELECT N_Reserva FROM Reserva WHERE N_Reserva=3));
INSERT INTO Recibo VALUES(686845168,51251,'2009-02-09',(SELECT N_Reserva FROM Reserva WHERE N_Reserva=4));
INSERT INTO Recibo VALUES(616841451,51521,'2009-02-09',(SELECT N_Reserva FROM Reserva WHERE N_Reserva=5));
INSERT INTO Recibo VALUES(265223669,51151,'2009-02-09',(SELECT N_Reserva FROM Reserva WHERE N_Reserva=6));
INSERT INTO Recibo VALUES(268484294,51551,'2009-02-09',(SELECT N_Reserva FROM Reserva WHERE N_Reserva=7));
INSERT INTO Recibo VALUES(221154988,51651,'2009-02-09',(SELECT N_Reserva FROM Reserva WHERE N_Reserva=8));
INSERT INTO Recibo VALUES(551849985,51571,'2009-02-09',(SELECT N_Reserva FROM Reserva WHERE N_Reserva=9));
INSERT INTO Recibo VALUES(841961861,51581,'2009-02-09',(SELECT N_Reserva FROM Reserva WHERE N_Reserva=10));
INSERT INTO Recibo VALUES(681845168,51591,'2009-02-09',(SELECT N_Reserva FROM Reserva WHERE N_Reserva=11));
INSERT INTO Recibo VALUES(611841451,51501,'2009-02-09',(SELECT N_Reserva FROM Reserva WHERE N_Reserva=12));
INSERT INTO Recibo VALUES(261223669,515121,'2009-02-09',(SELECT N_Reserva FROM Reserva WHERE N_Reserva=13));
